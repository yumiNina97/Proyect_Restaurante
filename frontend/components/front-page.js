    ...
    <div class="page-layout">
        <main class="page-layout__main-content">
            ...
            <section class="main-hero">
                <img class="main-hero__main-image" src="assets/images/plate-deco-1.webp">
        ...
        <aside class="page-layout__sidebar">
            <div class="promo-links">
                <a href="#/menu" class="promo-links__item"><img src="assets/images/promo-menu.webp" class="promo-links__image"><span class="promo-links__text">MENU ➲</span></a>
                <a href="#/booktable" class="promo-links__item"><img src="assets/images/promo-reservation.webp" class="promo-links__image"><span class="promo-links__text">RESERVATION ➲</span></a>
                <a href="#/about" class="promo-links__item"><img src="assets/images/promo-restaurant.webp" class="promo-links__image"><span class="promo-links__text">OUR RESTAURANT ➲</span></a>
            </div>
        </aside>
    </div>
`;
